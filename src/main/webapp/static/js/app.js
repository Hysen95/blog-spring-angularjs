...
var App = angular.module('App', ["ngFlash", "ngRoute", "720kb.tooltips", "ui.bootstrap", "wt.responsive"])
...
.controller("AppController", 
    ...
    $rootScope.successAlert = function (message) {
        var id = Flash.create('success', message, APP_CONSTANTS.flashMessage.timeout, {class: 'custom-class', id: 'custom-id'}, true);
    }
    
    $rootScope.errorAlert = function (message) {
        var id = Flash.create('danger', message, APP_CONSTANTS.flashMessage.timeout, {class: 'custom-class', id: 'custom-id'}, true);
    }
